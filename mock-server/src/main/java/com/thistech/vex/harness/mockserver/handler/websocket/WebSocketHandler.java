...
@Component
@ConditionalOnProperty(prefix = "servers.web-socket", name = "enable", havingValue = "true")
@ChannelHandler.Sharable
public class WebSocketHandler extends ServerHandler {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        if ("/".equals(req.getUri())) {
            ByteBuf content = WebSocketIndexPage.getContent(getWebSocketLocation(req));
