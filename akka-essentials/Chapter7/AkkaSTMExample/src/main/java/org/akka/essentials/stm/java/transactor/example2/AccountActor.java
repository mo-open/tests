...
import org.akka.essentials.stm.java.transactor.example2.msg.AccountBalance;
import org.akka.essentials.stm.java.transactor.example2.msg.AccountCredit;
import org.akka.essentials.stm.java.transactor.example2.msg.AccountDebit;
...
public class AccountActor extends UntypedTransactor {
    ...
    public boolean normally(Object message) {
        if (message instanceof AccountBalance) {
            ...
            sender().tell(new AccountBalance(accountNumber, balance.get()), getSelf());
            return true;
        }
        return false;
    }
